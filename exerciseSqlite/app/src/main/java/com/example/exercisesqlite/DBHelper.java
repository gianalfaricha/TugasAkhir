...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "create table mahasiswa " + "(id integer primary key, nim text,nama text,phone text,email text,address text)"
        );
    }
    ...
    public boolean insertContact (String nim, String nama, String phone, String email,String address) {
